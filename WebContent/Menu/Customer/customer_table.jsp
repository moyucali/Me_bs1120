...
var QueryUrl="http://localhost:8080/<%=request.getContextPath()%>/customer/queryAll";
	$(function() {	
		//1.初始化Table
					...
					.bootstrapTable(
							{
								...
								onLoadSuccess: function (aa, bb, cc) {
					                ...
					                $('#tb_Table font').editable({
					                    type: "select",
					                    source: [{ value: "1", text: "男" }, 
					                    	{ value: "0", text: "女" }],
					                    title: "选择性别",           //编辑框的标题
					                    url: function (params) {
					                    	//alert("editData:" + JSON.stringify(params.value));
					                ...
					                $('#tb_Table li').editable({
					                    type: "select",
					                    source: [{ value: "普通客户", text: "普通客户" }, 
					                    	{ value: "高级客户", text: "高级客户" }, 
					                    	{value:"贵宾",text:"贵宾"},{value:"黑户",text:"黑户"}],
					                    title: "选择级别",           //编辑框的标题
					                    url: function (params) {
					                    	//alert("editData:" + JSON.stringify(params.value));
					                        curRow[curRow.newField] = params.value;
								...
								columns : [
										...
										},
										{
									        ...
									        formatter : function(value, row,
													index) {
												var strHtml = "<li style='color:blue' >"
														+ value + "</li>";
												return strHtml;
											}
										},
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var strHtml = "<span style='color:green' onclick='selectCust()'>详细信息<span/>";
												return strHtml;
											}
										}, 
										]
...
<body>
	<div class="panel-body" style="padding-bottom: 0px;">
		...
		<div id="toolbar" class="btn-group">
			...
			<font style="color:blue;	font-size: 11px;">注:客户表仅显示部分客户信息，如需查看更多客户信息请点击</font>
			<font color="green">“详细信息”</font>
		</div>
