...
var QueryUrl="http://localhost:8080/<%=request.getContextPath()%>/dept/queryAll";
	$(function() {	
		//1.初始化Table
					...
					.bootstrapTable(
							{
								...
								uniqueId : "deptno", //每一行的唯一标识，一般为主键列
...
<body>
	<div class="panel-body" style="padding-bottom: 0px;">
		...
		<div id="toolbar" class="btn-group">
			...
			<font style="color:blue;	font-size: 12px;">注:删除部门后该部门成员会变为</font>
			<font color="red" style="font-size: 13px;">“无归属”</font>
		</div>
