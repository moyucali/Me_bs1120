...
var QueryUrl="http://localhost:8080/<%=request.getContextPath()%>/emp/queryAll";
	$(function() {	
		//1.初始化Table
					...
					.bootstrapTable(
							{
					                        ...
					                        $.ajax({
					                            ...
					                            success: function (data, status) {
					                                $.each(JSON.parse(data), function (key, value) {
					                                    result.push({ value: value.dname, text: value.dname });
					                                });
					                            }
					                        });
					                        return result;
								...
								columns : [
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var strHtml = "<p style='color:blue'>"
														+ value + "</p>";
												return strHtml;
											}
										},
										...
										},
										{
									        ...
									        formatter : function(value, row,
									        	...
									        	if(value==""){
									        		value="无归属";
									        		var strHtml = "<span style='color:red' >"
														+ value + "</span>";
									        		return strHtml;
									        	}else{
									        		var strHtml = "<span style='color:blue' >"
														+ value + "</span>";
									        		return strHtml;
									        	}
